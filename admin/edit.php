                                                            ...
                                                            <table class="table table-bordered mb-0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['blood_pressure']; ?>" name="blood_pressure" placeholder="ความดันโลหิต"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['heart']; ?>" name="heart" placeholder="อัตราการเต้นหัวใจ"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"><input type="text" id="company-column" class="form-control" value="<?php echo $row['height']; ?>" name="height" placeholder="ส่วนสูง"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['waistline']; ?>" name="waistline" placeholder="เส้นรอบเอว"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['walk']; ?>" name="walk" placeholder="เดิน 6 นาที"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['Stepinplace']; ?>" name="Stepinplace" placeholder="เดินยำก้าว 2 นาที"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['Chair_stand']; ?>" name="Chair_stand" placeholder="กยืนจากเก้าอี้ "></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['Arm']; ?>" name="Arm" placeholder="งอแขนพับศอก"></td>
                                                                        <td class="text-bold-500">ครั้ง</td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['Sit']; ?>" name="Sit" placeholder="นั่งเก้าอี้ยื่นแขนแตะปลายเท้า"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['Back_scratch']; ?>" name="Back_scratch" placeholder="การเอื้อมแขนแตะมือด้านหลัง"></td>
                                                                        <td class="text-bold-500">นิ้ว</td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" id="company-column" class="form-control" value="<?php echo $row['up_and_go']; ?>" name="up_and_go" placeholder="การลุกเดินจากเก้าอี้ไปและกลับ"></td>
