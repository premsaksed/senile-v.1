...
function fncCal()
{
	document.form1.txt3.value = parseInt(document.form1.txt2.value)

}
function fncCal1()
{	
	
    var a = parseInt(document.form1.txt1.value) 
	document.form1.txt4.value = parseInt(document.form1.txt1.value) 
	if(a>=1&&a<=10){
		var ss = 'สสส'
...
$query = "
SELECT Max(Arm) AS totol, MIN(Arm) AS totol1, DATE_FORMAT(`datesave`, '%Y%') AS `datesave` FROM Records GROUP BY DATE_FORMAT(`datesave`, '%Y%');
";
