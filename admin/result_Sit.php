                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>รายงานผลนั่งเก้าอี้ยื่นแขนแตะปลายเท้า</h3>
                            <br><br>     </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>นั่งเก้าอี้ยื่นแขนแตะปลายเท้า</h4>
                                </div>
                                <div class="card-body">
                                    <div id="area"></div>
                                </div>
...
$query = "
SELECT Max(Sit) AS totol, MIN(Sit) AS totol1, DATE_FORMAT(`datesave`, '%Y%') AS `datesave` FROM Records GROUP BY DATE_FORMAT(`datesave`, '%Y%');
";
