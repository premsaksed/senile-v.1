...
$query = "
SELECT Max(Stepinplace) AS totol, MIN(Stepinplace) AS totol1, DATE_FORMAT(`datesave`, '%Y%') AS `datesave` FROM Records GROUP BY DATE_FORMAT(`datesave`, '%Y%');
";
