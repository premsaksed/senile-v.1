                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>รายงานผลอัตราการเต้นของหัวใจ</h3>
                            <br><br>     </div>
...
$query = "
SELECT Max(heart) AS totol, MIN(heart) AS totol1, DATE_FORMAT(`datesave`, '%Y%') AS `datesave` FROM Records GROUP BY DATE_FORMAT(`datesave`, '%Y%');
";
