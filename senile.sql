...
--
-- Host: localhost:8889
-- Generation Time: Dec 03, 2021 at 09:34 AM
...
CREATE TABLE `Records` (
  ...
  `amperes` varchar(255) NOT NULL,
  `district` varchar(255) NOT NULL,
  `phone` varchar(10) NOT NULL,
  `congenital` varchar(255) NOT NULL,
  `blood_pressure` int(255) NOT NULL,
  `result_blood_pressure` int(1) NOT NULL,
  `heart` varchar(255) NOT NULL,
  `result_heart` int(1) NOT NULL,
  `weight` int(255) NOT NULL,
  `height` int(255) NOT NULL,
  `BMI` int(55) NOT NULL,
  `result_BMI` int(1) NOT NULL,
  `waistline` varchar(255) NOT NULL,
  `result_waistline` int(1) NOT NULL,
  `walk` varchar(255) NOT NULL,
  `result_walk` int(1) NOT NULL,
  `Stepinplace` varchar(255) NOT NULL,
  `result_Stepinplace` int(1) NOT NULL,
  `Chair_stand` varchar(255) NOT NULL,
  `result_Chair_stand` int(1) NOT NULL,
  `Arm` varchar(255) NOT NULL,
  `result_Arm` int(1) NOT NULL,
  `Sit` varchar(255) NOT NULL,
  `result_Sit` int(1) NOT NULL,
  `Back_scratch` varchar(255) NOT NULL,
  `result_Back_scratch` int(1) NOT NULL,
  `up_and_go` varchar(255) NOT NULL,
  `result_up_and_go` int(1) NOT NULL,
  `NO` int(1) NOT NULL,
  `inspector` text NOT NULL,
  `datesave` varchar(255) NOT NULL
...
INSERT INTO `Records` (`ID`, `prefix`, `fname`, `gender`, `age`, `address`, `province`, `amperes`, `district`, `phone`, `congenital`, `blood_pressure`, `result_blood_pressure`, `heart`, `result_heart`, `weight`, `height`, `BMI`, `result_BMI`, `waistline`, `result_waistline`, `walk`, `result_walk`, `Stepinplace`, `result_Stepinplace`, `Chair_stand`, `result_Chair_stand`, `Arm`, `result_Arm`, `Sit`, `result_Sit`, `Back_scratch`, `result_Back_scratch`, `up_and_go`, `result_up_and_go`, `NO`, `inspector`, `datesave`) VALUES
(2, 2, 'วราภรณ์ ศิริ', 1, 65, '58', '33', '496', '450603', '0872578789', 'ความดัน เบาหวาน ', 243, 3, '91', 1, 40, 149, 18, 1, '26', 1, '680', 2, '180', 3, '15', 2, '23', 3, '6', 3, '0', 2, '7', 1, 1, 'สมหมาย', '2021/12/01'),
(3, 2, 'วราภรณ์ ศิริ', 2, 65, '58', '33', '496', '450603', '0872578789', 'ความดัน เบาหวาน ', 99, 3, '91', 1, 40, 149, 18, 1, '26', 1, '680', 2, '180', 3, '15', 2, '23', 3, '6', 3, '0', 2, '7', 1, 1, '', '2020/11/22'),
(4, 2, 'วราภรณ์ ศิริ', 2, 65, '58', '33', '496', '450603', '0872578789', 'ความดัน เบาหวาน ', 143, 3, '91', 1, 40, 149, 18, 1, '26', 1, '680', 2, '180', 3, '15', 2, '23', 3, '6', 3, '0', 2, '7', 1, 1, '', '2020/11/29'),
(6, 2, 'วราภรณ์ ศิริ', 2, 65, '58', '33', '496', '450603', '0872578789', 'ความดัน เบาหวาน ', 143, 3, '91', 1, 40, 149, 18, 1, '26', 1, '680', 2, '180', 3, '15', 2, '23', 3, '6', 3, '0', 2, '7', 1, 1, '', '2020/11/29');
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'supper', 'admin', 'A');
